...
$idcargament = $_GET["idcargament"];

$cargaments = new Cargament();
$registers = $cargaments->search_id($idcargament);
...
?>
  ...
  <body>
    ...
    <section class="home-section">
      ...
      <div class="cuadro">
        <form action="update_cargament.php" method="POST" class="form-control" align="center" style="margin-top: -60px;">
          <div class="container">
            <div class="form-info">
              <div class="info">
                <h2>Register Output</h2>
                <input type="hidden" name="idcargament" value="<?= $idcargament ?>">
                <div class="input-group">
                  <input type="text" name="foil" placeholder="N°. Foil" required value="<?= $row['foil'] ?>" readonly="disable"><br><br>
                </div>
                <div class="input-group">
                  <input type="text" name="cargament" placeholder="Cargament" required value="<?= $row['cargament'] ?>" readonly="disable"><br><br>
                </div>
                <div class="input-group">
                  <input type="text" name="weight" placeholder="Weight" required value="<?= $row['weights'] ?>" readonly="disable"><br>
                </div>
                <div class="input-group">
                  <input type="text" name="types" placeholder="Type" required value="OutPut" readonly="disable"><br>
                </div>
                <div class="input-group">
                  <input type="date" name="dates_input" placeholder="Date Input" required value="<?= $row['dates_input'] ?>" readonly="disable"><br>
                </div>
                <div class="input-group">
                  <input type="time" name="times_input" placeholder="Time Input" required value="<?= $row['times_input'] ?>" readonly="disable"><br>
                </div>
                <div class="input-group">
                  <input type="date" name="dates_output" placeholder="Date Output" required><br>
                </div>
                <div class="input-group">
                  <input type="time" name="times_output" placeholder="Time Output" required><br>
                </div><br>
                <input type="submit" value="Uptade" class="btn btn-outline-success">
        </form>
      </div>
      </div>
      </div>
