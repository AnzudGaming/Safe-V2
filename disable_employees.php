        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td>
                <a href="update_enable_employee.php?idemployee=<?= $row['idemployee'] ?>" style="text-decoration: none;" onclick="confirmate(event)"><button type="button" class="btn btn-outline-success">
...
<script type="text/javascript">
  function confirmate(e) {
    ...
    swalWithBootstrapButtons.fire({
      title: 'Are you sure?',
      text: "You want to enable this employee!",
      icon: 'warning',
      ...
      if (result.isConfirmed) {
        ...
        swalWithBootstrapButtons.fire(
          'Cancelled',
          'The employee has not been enabled',
          'error'
        )
      }
    })
