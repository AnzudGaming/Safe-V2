...
$users = new User();
$result = $users->disable($iduser);
$registers = $users->show1();
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= $row['type_user']; ?></td>
                            <td>
                            <a href="form_edit_user.php?iduser=<?= $row['iduser'] ?>" style="text-decoration: none;"><button type="button" class="btn btn-outline-warning">
                  ...
                  <a href="update_disable_user.php?iduser=<?= $row['iduser'] ?>" style="text-decoration: none;"onclick="confirmate(event)"><button type="button" class="btn btn-outline-danger">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
  ...
  <script src="https://cdn.datatables.net/responsive/2.5.0/js/responsive.bootstrap5.min.js"></script>
    <div>
        ...
        ?>
            <script>
                setTimeout(function() {
                    window.location = "disable_users.php"
                }, 3000)
            </script>
