...
$registers = $cargaments->showInput();
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td>
                <a href="form_output.php?idcargament=<?= $row['idcargament'] ?>" style="text-decoration: none;"><button type="button" class="btn btn-outline-warning">
