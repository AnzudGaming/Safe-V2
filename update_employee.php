...
$result = $employees->update($names, $last_name, $age, $date_birth, $idemployee);
    ...
    <body>
                            ...
                            <div class="info">
                                ...
                                <div class="input-group">
                                    <input type="text" name="cod_emp" placeholder="Employee Code" required
                                        readonly="disable"><br><br>
                                </div>
                                <div class="input-group">
                                    <input type="text" name="names" placeholder="Names" required><br><br>
                                </div>
                                <div class="input-group">
        ...
        <div>
            ...
            if ($result) {
                ...
                <script>
                    setTimeout(function () {
                        window.location = "form_edit_employee.php"
                    }, 3000)
                </script>
                <script>
                    const Toast = Swal.mixin({
