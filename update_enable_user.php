...
$users = new User();
$result = $users->enable($iduser);
$registers = $users->show2();
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= $row['type_user']; ?></td>
                            <td>
                                <a href="update_enable_user.php?iduser=<?= $row['iduser'] ?>" style="text-decoration: none;"><button type="button" class="btn btn-outline-success">
