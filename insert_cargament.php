...
$cargament=$_POST["cargament"];
$weights=$_POST["weight"];
$types=$_POST["types"];
$dates_input=$_POST["dates_input"];
$times_input=$_POST["times_input"];

$result=$cargaments->insert($cargament, $weights, $types, $dates_input, $times_input);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="sidebar close">
  ...
  <section class="home-section">
    ...
    <div class="cuadro">
        <form action="insert_cargament.php" method="POST" class="form-control" align="center">
            <div class="container">
                <div class="form-info">
                    <div class="info">
    ...
    <div>
        ...
        <?php
            ...
            <script>
            setTimeout(function (){
            window.location="form_cargament.php"
            }, 3000)
            </script>
            <script>
                const Toast = Swal.mixin({
