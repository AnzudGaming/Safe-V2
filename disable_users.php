        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td><?= $row['type_user']; ?></td>
              <td>
                <a href="update_enable_user.php?iduser=<?= $row['iduser'] ?>" style="text-decoration: none;" onclick="confirmate(event)"><button type="button" class="btn btn-outline-success">
