...
<body>
  ...
  <div class="wrapper">
    <div class="display">
      <div id="tiempo">00:00:00 PM</div>
    </div>
    <span></span>
    <span></span>
  </div>
  <div class="info2">
    <h1>Por motivos de resolución, favor de rotar su dispositivo</h1>
  </div>
  <div class="cuadro">
        ...
        <div class="form-info">
          <div class="info">
            ...
            <div class="input-group">
              <input type="text" placeholder="Username" name="user" required id="user" autocomplete="off"><br><br>
            </div>
            <div class="input-group">
              <input type="password" placeholder="Password" name="pass" required id="pass" autocomplete="off"><br><br>
            </div><br>
