...
$types = $_POST["types"];
$dates_output = $_POST["dates_output"];
$times_output = $_POST["times_output"];
$idcargament = $_POST["idcargament"];

$result = $cargaments->update($types, $dates_output, $times_output, $idcargament);
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
  ...
  <section class="home-section">
    ...
    <div class="cuadro">
      <form action="update_cargament.php" method="POST" class="form-control" align="center" style="margin-top: -40px;">
        <div class="container">
          <div class="form-info">
            <div class="info">
              <h2>Register Cargament</h2>
              <div class="input-group">
                <input type="text" name="cargament" placeholder="Cargament" required><br><br>
              </div>
              <div class="input-group">
                <input type="text" name="weight" placeholder="Weight" required><br>
              </div>
              <div class="input-group">
                <input type="text" name="types" placeholder="Type" required><br>
              </div>
              <div class="input-group">
                <input type="date" name="dates_input" placeholder="Date Input" required><br>
              </div>
              <div class="input-group">
                <input type="time" name="times_input" placeholder="Time Input" required><br>
              </div>
              <div class="input-group">
  ...
  <div>
    ...
    ?>
      <script>
        setTimeout(function() {
          window.location = "cargament_output.php"
        }, 3000)
      </script>
    ...
    <?php
      ...
      <script>
        setTimeout(function() {
          window.location = "form_output.php"
        }, 3000)
      </script>
      <script>
        const Toast = Swal.mixin({
