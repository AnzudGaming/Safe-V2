...
$fkemployee = $_POST["fkemployee"];

$result = $users->insert($user, $pass, $type_user, $fkemployee);
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <ul class="nav-links">
      ...
      <li>
        ...
        <ul class="sub-menu">
          ...
          <li><a href="cargament_outpu.php">List Output</a></li>
        </ul>
      </li>
      <li>
        <div class="iocn-link">
  ...
  <section class="home-section">
    ...
    <div class="cuadro">
      <form action="insert_user.php" method="POST" class="form-control" align="center" style="margin-top: -60px;" onsubmit="verificarPasswords(); return false">
        <div class="container">
          <div class="form-info">
            <div class="info">
              <h2>New User</h2>
              ...
              <div class="input-group">
                <input type="password" placeholder="Confirmation" required id="pass2"><br>
                <div class="answer"></div>
              </div><br>
              <div class="input-group">
                <select name="fkemployee" id="" class=" js-example-placeholder-single js-states form-select" required>
              ...
              <input type="submit" value="Register" class="btn btn-outline-success"><br><br>
      </form>
    </div>
    </div>
    </div>
