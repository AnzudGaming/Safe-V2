...
$result = $employees->enable($idemployee);
$registers = $employees->show1();
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td>
              <a href="update_enable_employee.php?idemployee=<?= $row['idemployee'] ?>" style="text-decoration: none;" onclick="confirmate(event)"><button type="button" class="btn btn-outline-success" disabled>
